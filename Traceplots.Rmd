...
mcmc_trace(fit_dl_now_draws, pars = parameters, facet_args = list(nrow = 4, ncol = 2), iter1 =3001)
...
mcmc_trace(fit_dl_short_draws, pars = parameters, facet_args = list(nrow = 4, ncol = 2), iter1 =3001)
...
mcmc_trace(fit_dl_long_draws, pars = parameters, facet_args = list(nrow = 4, ncol = 2), iter1 =3001)
...
mcmc_trace(fit_dl_never_draws, pars = parameters, facet_args = list(nrow = 4, ncol = 2), iter1 =3001)
